...
public class StreamDemo2 {
    ...
    public static void main(String[] args) throws IOException {
        ...
        System.out.println("streamFromValues = " +
                streamFromValues.collect(Collectors.toList()));
        ...
        System.out.println("Stream From Files = " +
                streamFromFile.collect(Collectors.toList()));
        ...
        IntStream streamFromString = "222".chars();
        System.out.print("StreamFromString = ");
        streamFromString.forEach((e) -> System.out.print(e + ","));
        System.out.println();

        //with help Stream.builder

        Stream.Builder<String> builder = Stream.builder();

        Stream<String> streamFormBuilder = builder.add("a1").add("a2").add("a3").build();

        System.out.println("StreamFromBuilder = " +
                streamFormBuilder.collect(Collectors.toList()));
    ...
    private static void testFilterAndCount(){
        ...
        Collection<People> peoples = Arrays.asList(
                ...
                new People("Johan",32,Sex.MAN),
                new People("Helm",54,Sex.WOMEN),
                new People("Peter",45,Sex.MAN)
        );
        ...
        double manAverage = peoples.stream().filter((p) -> p.getSex() == Sex.MAN)
                .mapToInt(People::getAge).average().getAsDouble();
        System.out.println("manyAverageAge = " + manAverage);
